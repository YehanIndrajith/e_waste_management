<div class="dashboard_sidebar">
    ...
    <ul class="dashboard_link">
      ...
      <li><a href="{{route('user.quiz.index')}}"><i class="fas fa-list-ul"></i> 1st Quiz</a></li>
      ...
      <li><a href="{{ route('user.collectionPoints.index') }}"><i class="fal fa-gift-card"></i> Addresses</a></li>
      <li>
