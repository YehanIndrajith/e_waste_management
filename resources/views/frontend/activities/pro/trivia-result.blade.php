...
<style>
    ...
    .btn-dashboard, .btn-next-activity {
        background: linear-gradient(to right, #2ecc71, #3498db);
        color: white;
        border: none;
        padding: 12px 25px;
    ...
    .btn-dashboard:hover, .btn-next-activity:hover {
    ...
    <div class="quiz-results-container">
        <div class="quiz-score-summary">
            ...
            <div class="result-message">
                @if($score == $totalQuestions)
                    <p>Congratulations! You got {{$score}} answers correct!</p>
                @elseif($score >= $totalQuestions / 2)
            ...
            <div class="action-buttons">
                <a href="{{ route('user.activities.pro.trivia.index') }}" class="btn-try-again">
