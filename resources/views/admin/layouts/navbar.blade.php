<nav class="navbar navbar-expand-lg main-navbar" 
    ...
    <!-- Right Side -->
    <ul class="navbar-nav navbar-right" style="display: flex; align-items: center; gap: 15px;">
        <!-- Messages -->
        ...
        <li class="dropdown">
            <a href="#" 
               ...
               style="color: #333;
                      ...
                      align-items: center;
                      gap: 10px;">
                <div class="d-sm-none d-lg-inline-block" style="font-weight: 500;">Hi, Admin</div>
            </a>
            <div class="dropdown-menu dropdown-menu-right"
                ...
                <div class="dropdown-divider" style="border-color: rgba(81, 187, 106, 0.1);"></div>
